...
export default function Departments() {
  ...
  return (
    <section id="sections" className="py-20 lg:py-24 relative" dir={isArabic ? "rtl" : "ltr"}>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-7xl mx-auto px-6">
        ...
        <div className="group bg-white rounded-3xl p-8 text-center hover:-translate-y-2 hover:shadow-2xl hover:shadow-slate-200/50 shadow-sm border border-slate-100 transition-all duration-300 flex flex-col">
          <div className="w-16 h-16 mx-auto mb-6 bg-slate-50 rounded-2xl flex items-center justify-center group-hover:bg-[#35C6A8]/10 group-hover:scale-110 transition-all duration-300">
            <img src={techIcon} alt="Tech Section" className="w-8 h-8 opacity-90 group-hover:opacity-100 transition-opacity" />
          </div>
        ...
        <div className="group bg-white rounded-3xl p-8 text-center hover:-translate-y-2 hover:shadow-2xl hover:shadow-slate-200/50 shadow-sm border border-slate-100 transition-all duration-300 flex flex-col">
          <div className="w-16 h-16 mx-auto mb-6 bg-slate-50 rounded-2xl flex items-center justify-center group-hover:bg-[#35C6A8]/10 group-hover:scale-110 transition-all duration-300">
            <img src={prIcon} alt="Public Relations Section" className="w-8 h-8 opacity-90 group-hover:opacity-100 transition-opacity" />
          </div>
        ...
        <div className="group bg-white rounded-3xl p-8 text-center hover:-translate-y-2 hover:shadow-2xl hover:shadow-slate-200/50 shadow-sm border border-slate-100 transition-all duration-300 flex flex-col">
          <div className="w-16 h-16 mx-auto mb-6 bg-slate-50 rounded-2xl flex items-center justify-center group-hover:bg-[#35C6A8]/10 group-hover:scale-110 transition-all duration-300">
            <img src={mediaIcon} alt="Media Section" className="w-8 h-8 opacity-90 group-hover:opacity-100 transition-opacity" />
          </div>
